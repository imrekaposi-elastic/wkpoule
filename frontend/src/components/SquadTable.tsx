      ...
      <table className="min-w-full text-sm">
        <thead className="bg-pitch-50 text-left text-xs uppercase tracking-wide text-pitch-800">
          <tr>
            ...
            <th className="px-3 py-2.5 text-center">{t("teams.player.age")}</th>
            <th className="px-3 py-2.5 text-center">{t("teams.player.height")}</th>
            <th className="px-3 py-2.5 text-center">{t("teams.player.weight")}</th>
          ...
          {players.map((player) => (
            <tr key={player.id} className="border-t border-gray-100 even:bg-gray-50/80">
              ...
              <td className="px-3 py-2.5 text-center text-gray-700">
                {player.age != null && player.age > 0 ? player.age : "—"}
              </td>
              <td className="px-3 py-2.5 text-center text-gray-700 whitespace-nowrap">
                {formatMetric(player.height_cm, "cm")}
              </td>
              <td className="px-3 py-2.5 text-center text-gray-700 whitespace-nowrap">
                {formatMetric(player.weight_kg, "kg")}
              </td>
