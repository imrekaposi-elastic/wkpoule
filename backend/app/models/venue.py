...
class Venue(Base):
    ...
    review_es: Mapped[str | None] = mapped_column(Text, nullable=True)
    review_it: Mapped[str | None] = mapped_column(Text, nullable=True)
    review_he: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    accessibility_es: Mapped[str | None] = mapped_column(Text, nullable=True)
    accessibility_it: Mapped[str | None] = mapped_column(Text, nullable=True)
    accessibility_he: Mapped[str | None] = mapped_column(Text, nullable=True)
